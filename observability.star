...
bridge = import_module("./cdk_bridge_infra.star")
        ...
        config={
            "config.yml": struct(
                ...
                data={
                    ...
                    "zkevm_bridge_address": bridge.get_key_from_config(
                        plan, args, "polygonZkEVMBridgeAddress"
                    ),
                    "polygon_zkevm_address": bridge.get_key_from_config(
                        plan, args, "rollupAddress"
                    ),
                    "rollup_manager_address": bridge.get_key_from_config(
                        plan, args, "polygonRollupManagerAddress"
                    ),
                    "global_exit_root_address": bridge.get_key_from_config(
                    ...
                    "pol_token_address": bridge.get_key_from_config(
