...
def run(
    ...
    Args:
        ...
        deploy_cdk_bridge_infra(bool): true
        deploy_zkevm_permissionless_node(bool): true
        deploy_observability(bool): true
        zkevm_prover_image(string): hermeznetwork/zkevm-prover:v6.0.0
        zkevm_node_image(string): 0xpolygon/cdk-validium-node:0.6.4-cdk.2
        zkevm_dac_image(string): 0xpolygon/cdk-data-availability:0.0.7
        zkevm_contracts_image(string): leovct/zkevm-contracts # the tag(number)(number)(number)(number)(number)(number)(number)(number) is automatically replaced by the value of /zkevm_rollup_fork_id/
        zkevm_agglayer_image(string): 0xpolygon/agglayer:0.1.1
        zkevm_bridge_service_image(string): hermeznetwork/zkevm-bridge-service:v0.4.2
        panoptichain_image(string): minhdvu/panoptichain
        zkevm_bridge_ui_image(string): nulyjkdhthz/zkevm-bridge-ui:kurtosis
        zkevm_bridge_proxy_image(string): haproxy:2.9.7
        zkevm_hash_db_port(int): 50061
        zkevm_executor_port(int): 50071
        zkevm_aggregator_port(int): 50081
        zkevm_pprof_port(int): 6060
        zkevm_prometheus_port(int): 9091
        zkevm_data_streamer_port(int): 6900
        zkevm_rpc_http_port(int): 8123
        zkevm_rpc_ws_port(int): 8133
        zkevm_bridge_rpc_port(int): 8080
        zkevm_bridge_grpc_port(int): 9090
        zkevm_bridge_ui_port(int): 80
        zkevm_agglayer_port(int): 4444
        zkevm_dac_port(int): 8484
        zkevm_l2_sequencer_address(string): "0x5b06837A43bdC3dD9F114558DAf4B26ed49842Ed"
        zkevm_l2_sequencer_private_key(string): "0x183c492d0ba156041a7f31a1b188958a7a22eebadca741a7fe64436092dc3181"
        zkevm_l2_aggregator_address(string): "0xCae5b68Ff783594bDe1b93cdE627c741722c4D4d"
        zkevm_l2_aggregator_private_key(string): "0x2857ca0e7748448f3a50469f7ffe55cde7299d5696aedd72cfe18a06fb856970"
        zkevm_l2_claimtxmanager_address(string): "0x5f5dB0D4D58310F53713eF4Df80ba6717868A9f8"
        zkevm_l2_claimtxmanager_private_key(string): "0x8d5c9ecd4ba2a195db3777c8412f8e3370ae9adffac222a54a84e116c7f8b934"
        zkevm_l2_timelock_address(string): "0x130aA39Aa80407BD251c3d274d161ca302c52B7A"
        zkevm_l2_timelock_private_key(string): "0x80051baf5a0a749296b9dcdb4a38a264d2eea6d43edcf012d20b5560708cf45f"
        zkevm_l2_admin_address(string): "0xE34aaF64b29273B7D567FCFc40544c014EEe9970"
        zkevm_l2_admin_private_key(string): "0x12d7de8621a77640c9241b2595ba78ce443d05e94090365ab3bb5e19df82c625"
        zkevm_l2_loadtest_address(string): "0x81457240ff5b49CaF176885ED07e3E7BFbE9Fb81"
        zkevm_l2_loadtest_private_key(string): "0xd7df6d64c569ffdfe7c56e6b34e7a2bdc7b7583db74512a9ffe26fe07faaa5de"
        zkevm_l2_agglayer_address(string): "0x351e560852ee001d5D19b5912a269F849f59479a"
        zkevm_l2_agglayer_private_key(string): "0x1d45f90c0a9814d8b8af968fa0677dab2a8ff0266f33b136e560fe420858a419"
        zkevm_l2_dac_address(string): "0x5951F5b2604c9B42E478d5e2B2437F44073eF9A6"
        zkevm_l2_dac_private_key(string): "0x85d836ee6ea6f48bae27b31535e6fc2eefe056f2276b9353aafb294277d8159b"
        zkevm_l2_proofsigner_address(string): "0x7569cc70950726784c8D3bB256F48e43259Cb445"
        zkevm_l2_proofsigner_private_key(string): "0x77254a70a02223acebf84b6ed8afddff9d3203e31ad219b2bf900f4780cf9b51"
        zkevm_l2_keystore_password(string):"pSnv6Dh5s9ahuzGzH9RoCDrKAMddaX3m"
        zkevm_db_postgres_port(int): 5432
        zkevm_db_agglayer_hostname(string): agglayer-db
        zkevm_db_agglayer_name(string): agglayer_db
        zkevm_db_agglayer_user(string): agglayer_user
        zkevm_db_agglayer_password(string): PzycR2uB6PQv8ahj465ExvdyRLkknRNW
        zkevm_db_bridge_hostname(string): bridge-db
        zkevm_db_bridge_name(string): bridge_db
        zkevm_db_bridge_user(string): bridge_user
        zkevm_db_bridge_password(string): aXPqaRvgo5DfnTbHtpYS9rMhVpjvb6tY
        zkevm_db_dac_hostname(string): dac-db
        zkevm_db_dac_name(string): dac_db
        zkevm_db_dac_user(string): dac_user
        zkevm_db_dac_password(string): PzycR2uB6PQv8ahj465ExvdyRLkknRNW
        zkevm_db_event_hostname(string): event-db
        zkevm_db_event_name(string): event_db
        zkevm_db_event_user(string): event_user
        zkevm_db_event_password(string): rJXJN6iUAczh4oz8HRKYbVM8yC7tPeZm
        zkevm_db_pool_hostname(string): pool-db
        zkevm_db_pool_name(string): pool_db
        zkevm_db_pool_user(string): pool_user
        zkevm_db_pool_password(string): Qso5wMcLAN3oF7EfaawzgWKUUKWM3Vov
        zkevm_db_prover_hostname(string): prover-db
        zkevm_db_prover_name(string): prover_db
        zkevm_db_prover_user(string): prover_user
        zkevm_db_prover_password(string): SR5xq2KZPgvQkPDranCRhvkv6pnqfo77
        zkevm_db_state_hostname(string): state-db
        zkevm_db_state_name(string): state_db
        zkevm_db_state_user(string): state_user
        zkevm_db_state_password(string): rHTX7EpajF8zYDPatN32rH3B2pn89dmq
        l1_chain_id(int): 271828
        l1_preallocated_mnemonic(string): code code code code code code code code code code code quality
        l1_rpc_url(string): http://el-1-geth-lighthouse:8545
        l1_ws_url(string): ws://el-1-geth-lighthouse:8546
        zkevm_rollup_chain_id(int): 10101
        zkevm_rollup_fork_id(int): 9
        zkevm_rollup_consensus(string): PolygonValidiumEtrog
        polygon_zkevm_explorer(string): https://explorer.private/
        l1_explorer_url(string): https://sepolia.etherscan.io/
        zkevm_use_gas_token_contract(bool): false
        trusted_sequencer_node_uri(string): zkevm-node-sequencer-001:6900
