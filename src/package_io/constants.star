...
DEFAULT_IMAGES = {
    ...
    "cdk_sovereign_erigon_node_image": "hermeznetwork/cdk-erigon:v2.64.0-rc7",  # Type-1 CDK Erigon Sovereign
    ...
    "zkevm_bridge_service_image": "ghcr.io/0xpolygon/zkevm-bridge-service:v0.6.3-RC1",
