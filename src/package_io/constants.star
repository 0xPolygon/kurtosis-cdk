...
DEFAULT_IMAGES = {
    ...
    "aggkit_prover_image": "vcastellm/aggkit-prover:1.7.0",
    ...
    "op_succinct_proposer_image": "ghcr.io/agglayer/op-succinct/op-succinct-agglayer:v3.3.1-agglayer",
    ...
    "zkevm_bridge_service_image": "ghcr.io/0xpolygon/zkevm-bridge-service:v0.6.3-RC4",
