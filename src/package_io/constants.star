...
DEFAULT_IMAGES = {
    ...
    "aggkit_prover_image": "ghcr.io/agglayer/aggkit-prover:1.5.0",
    ...
    "geth_image": "ethereum/client-go:v1.16.5",
    "lighthouse_image": "sigp/lighthouse:v8.0.0-rc.1",
    "mitm_image": "mitmproxy/mitmproxy:11.1.3",
    "op_batcher_image": "us-docker.pkg.dev/oplabs-tools-artifacts/images/op-batcher:v1.16.0",
    "op_contract_deployer_image": "europe-west2-docker.pkg.dev/prj-polygonlabs-devtools-dev/public/op-deployer:v0.4.3-cdk",
    ...
    "op_succinct_proposer_image": "ghcr.io/agglayer/op-succinct:v3.2.3-fusaka",
    "status_checker_image": "ghcr.io/0xpolygon/status-checker:v0.2.8",
    "test_runner_image": "europe-west2-docker.pkg.dev/prj-polygonlabs-devtools-dev/public/e2e:c28ca34",
