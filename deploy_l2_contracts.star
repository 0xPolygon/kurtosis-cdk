...
def run(plan, args):
    ...
    l2_rpc_service = plan.get_service(name="cdk-erigon-sequencer" + args["deployment_suffix"])
    l2_rpc_url="http://{}:{}".format(l2_rpc_service.ip_address, l2_rpc_service.ports["rpc"].number)
