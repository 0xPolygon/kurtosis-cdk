...
cat upgrade/upgradePessimistic/upgrade_parameters.json.example |
    jq --arg rum 0x6c6c009cC348976dB4A908c92B24433d4F6edA43 \
...
#+begin_src bash
cast call --rpc-url "$rpc_url" 0x6c6c009cC348976dB4A908c92B24433d4F6edA43 'ROLLUP_MANAGER_VERSION()(string)'
#+end_src
