...
polycli wallet inspect --mnemonic "$seed" --addresses 9 | \
    ...
    awk 'BEGIN{split("sequencer,aggregator,claimsponsor,timelock,admin,loadtest,agglayer,dac,proofsigner",roles,",")} {print "l2_" roles[NR] "_address: \"" $1 "\""; print "l2_" roles[NR] "_private_key: \"0x" $2 "\"\n"}'
#+end_src
...
l2_claimsponsor_address: "0xc8273E02E94598F39e8Ec8867902D4807917A165"
l2_claimsponsor_private_key: "0x216a4646ea3dd753f799b7eb7d7f8fe57b96c01c1fcd5eec496d888f5a7677cd"
