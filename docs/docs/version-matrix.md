...
|-----------|-------------------------------|-----------------------|--------|
| aggkit | [0.9.0-rc2](https://github.com/agglayer/aggkit/releases/tag/v0.9.0-rc2) | [0.8.0](https://github.com/agglayer/aggkit/releases/tag/v0.8.0) | ⚡️ newer than stable |
