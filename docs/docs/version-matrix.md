...
| Component | Version Deployed in Kurtosis	 | Latest Stable Version | Status |
|-----------|-------------------------------|-----------------------|--------|
| geth | [1.17.4](https://github.com/ethereum/go-ethereum/releases/tag/v1.17.4) | [1.17.4](https://github.com/ethereum/go-ethereum/releases/tag/v1.17.4) | ✅ matches stable |
