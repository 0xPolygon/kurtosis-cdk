...
# Copy modified deployAggOracleCommittee.ts script
cp /opt/contract-deploy/deployAggOracleCommittee.ts /opt/zkevm-contracts/tools/deployAggOracleCommittee/deployAggOracleCommittee.ts
...
CUSTOM_PROVIDER="http://{{ .l2_rpc_name }}{{ .deployment_suffix }}:8545" \
