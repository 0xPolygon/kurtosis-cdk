...
DEFAULT_IMAGES = {
    "aggkit_image": "ghcr.io/agglayer/aggkit:0.2.0",  # https://github.com/agglayer/aggkit/pkgs/container/aggkit
    # "agglayer_image": "ghcr.io/agglayer/agglayer:0.2.5", # CDK Erigon PP Supported Agglayer Version
    ...
    "zkevm_contracts_image": "jhkimqd/zkevm-contracts:v9.0.0-rc.2-pp-fork.12",  # https://hub.docker.com/repository/docker/leovct/zkevm-contracts/tags
