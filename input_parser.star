DEFAULT_ARGS = {
    ...
    "event_db.hostname": "postgres-001",
    "event_db.port": 5432,
    "event_db.name": "event_db",
    "event_db.user": "event_user",
    "event_db.password": "redacted",
    "pool_db.hostname": "postgres-001",
    "pool_db.port": 5432,
    "pool_db.name": "pool_db",
    "pool_db.user": "pool_user",
    "pool_db.password": "redacted", 
    "prover_db.hostname": "postgres-001",
    "prover_db.port": 5432,
    "prover_db.name": "prover_db",
    "prover_db.user": "prover_user",
    "prover_db.password": "redacted",      
    "state_db.hostname": "postgres-001",
    "state_db.port": 5432,
    "state_db.name": "state_db",
    "state_db.user": "state_user",
    "state_db.password": "redacted",    
    "agglayer_db.hostname": "postgres-001",
    "agglayer_db.port": 5432,
    "agglayer_db.name": "agglayer_db",
    "agglayer_db.user": "agglayer_user",
    "agglayer_db.password": "redacted",    
    "bridge_db.hostname": "postgres-001",
    "bridge_db.port": 5432,
    "bridge_db.name": "bridge_db",
    "bridge_db.user": "bridge_user",
    "bridge_db.password": "redacted", 
    "dac_db.hostname": "postgres-001",
    "dac_db.port": 5432,
    "dac_db.name": "agglayer_db",
    "dac_db.user": "agglayer_user",
    "dac_db.password": "redacted",  
}
