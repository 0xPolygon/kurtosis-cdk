...
DEFAULT_IMAGES = {
    ...
    "agglayer_image": "ghcr.io/agglayer/agglayer:0.4.0-rc.5",
    "agglayer_contracts_image": "europe-west2-docker.pkg.dev/prj-polygonlabs-devtools-dev/public/agglayer-contracts:v0.0.0-rc.1.aggchain.multisig-fork.0",  # https://github.com/agglayer/agglayer-contracts/compare/v12.1.0-rc.3...feature/initialize-tool-refactor
