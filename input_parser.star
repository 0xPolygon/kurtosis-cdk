...
DEFAULT_IMAGES = {
    ...
    "op_succinct_contract_deployer_image": "nulyjkdhthz/op-succinct-contract-deployer:v1.2.10-agglayer",  # https://hub.docker.com/r/jhkimqd/op-succinct-contract-deployer
