...
DEFAULT_IMAGES = {
    ...
    "op_succinct_proposer_image": "ghcr.io/agglayer/op-succinct/op-succinct:v2.1.5-agglayer",  # https://github.com/agglayer/op-succinct/pkgs/container/op-succinct%2Fop-proposer
}
