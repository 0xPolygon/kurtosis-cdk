...
DEFAULT_ARGS = {
    ...
    "zkevm_sequence_sender_image": "hermeznetwork/zkevm-sequence-sender:v0.2.0-RC10",
    ...
    "cdk_erigon_node_image": "hermeznetwork/cdk-erigon:acceptance-2.0.0-beta17-a61220d-amd64",
