...
DEFAULT_IMAGES = {
    ...
    "op_succinct_contract_deployer_image": "vcastellm/op-succinct-contract-deployer:v2.2.0-agglayer",  # https://hub.docker.com/r/jhkimqd/op-succinct-contract-deployer
